...
} = require("../../controller/receptionist/NewsController");
...
NewsRouter.post("/news", authReceptionistMiddleware, createNews);
NewsRouter.put("/news/:id", authReceptionistMiddleware, updateNews);
NewsRouter.delete("/news/:id", authReceptionistMiddleware, deleteNews);
